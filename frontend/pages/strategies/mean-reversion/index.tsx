    ...
    return (<>
        ...
        <div className="p-10 pt-5">
            <div className="flex justify-start items-baseline flex-col mb-5">
                <h1 className="text-4xl bold">Mean Reversion</h1>
            </div>
            ...
            <div style={{display: "flex"}}>
                ...
                <div>
                    <Image src="/mean-reversion.png" alt="Mean Reversion Graph" width={3000} height={3000}></Image>
                    <Image src="/mr-buysell.png" alt="Mean Reversion Buy/Sell Graph" width={2000} height={2000}></Image>
                </div>
            </div>
        </div>
    </>)
